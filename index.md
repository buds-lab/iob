...
The IoB consortium connects industrial partners and researchers from the building and data science domains help each other understand what to do with all the IoT data generated by buildings. Literally billions of IoT devices are installed in buildings, but no one knows how to use all the data. 
