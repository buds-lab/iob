...
# NUS Internet of Buildings (IoB) Center

The IoB Center connects industrial partners and researchers from the building and data science domains. We work together to understand IoT data generated by buildings. Literally billions of IoT devices are installed in buildings, but no one knows how to use all the data. 
...
<!-- ## Data Science Education for Built Environment Professionals

Partners receive educational content to help their staff learn how to process IoT data from buildings outside of spreadsheets. -->
